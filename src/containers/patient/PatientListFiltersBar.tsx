  ...
  return (
    <div className="space-y-3">
      <div className="relative">
        <span className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4 text-charcoal-muted/60">
        ...
        <input
          ...
          className="h-11 w-full rounded-xl border border-slate-200 bg-white pl-11 pr-4 text-sm text-charcoal placeholder:text-charcoal-muted/50 focus:border-primary/50 focus:outline-none focus:ring-[3px] focus:ring-primary/10"
        />
        {isFetching && (
          <span className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-4 text-xs text-charcoal-muted">
            Buscando...
          </span>
        )}
      </div>
